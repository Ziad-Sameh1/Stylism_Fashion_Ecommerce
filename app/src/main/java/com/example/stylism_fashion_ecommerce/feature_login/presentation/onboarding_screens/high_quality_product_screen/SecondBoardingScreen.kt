...
@Composable
fun SecondBoardingScreen(navController: NavController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        OnboardingScreenImageCommon(
            drawableRes = R.drawable.ic_reach_everywhere,
            contentDescription = "",
            modifier = Modifier
                .fillMaxWidth()
                .fillMaxHeight(0.6f)
        ...
        OnboardingScreenHeaderCommon(
            headerContent = R.string.reach_everywhere,
            modifier = Modifier
                .fillMaxWidth()
                .fillMaxHeight(0.15f)
        ...
        OnboardingScreenBodyCommon(
            bodyContent = R.string.reach_everywhere_desc,
            modifier = Modifier
                .fillMaxWidth()
                .fillMaxHeight(0.55f)
                .padding(horizontal = 30.dp)
